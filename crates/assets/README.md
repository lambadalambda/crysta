...
Currently implemented: the [compressed packet decoder](../../docs/compression.md).
Unknown packet variants fail explicitly. Graphics interpretation, map formats,
and the local asset pack are separate M3 issues.
...
sizes, and independent hashes. They skip explicitly when dumps are absent.
