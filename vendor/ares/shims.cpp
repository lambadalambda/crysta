...
// Screen::frame completes refresh + video on the caller before Event::Frame.
// Session is single-thread confined; no worker may mutate lastFrame while the
// shim copies it. This is completion policy, not merely a mutual-exclusion lock.
