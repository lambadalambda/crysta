...
- Completed: exported and integrated into whole-state atomic stepping and profile7/103-byte snapshots, with ownership/facing/cadence coherence checks and explicit doorway standing policy. Integrated fresh replays and full core/native/Wasm regressions pass; the live browser uses the resulting frame key. Independent reviews passed.
