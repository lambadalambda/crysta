// Standalone read-only input-history research probe; build via input-admission-check.py.
...
fn main() {
    ...
    for f in 0..end {
        ...
        if f + 1 >= 1601 {
            ...
            let active = inputs
                ...
                .collect::<Vec<_>>()
                .join("+");
            writeln!(csv,"{},{},{:x},{},{},{:04x},{:04x},{:02x}{:04x},{},{},{:04x},{:04x},{},{},{},{},{},{},{:04x},{:04x},{:04x},{},{:04x}",f+1,active,u(0x47e),u(0x1000),u(0x1002),u(0x1004),u(0x1008),w[0x100c],u(0x100a),u(0x100e),u(0x1014),u(0x11010),u(0x11012),i(0x1028),i(0x102a),i(0x1100c),i(0x1100e),i(0x11018),i(0x1101a),u(0x13014),u(0x454),u(0x456), u(0x96a),u(0x96c)).unwrap();
            if f + 1 == 1601 || f + 1 == end {
    ...
    if let Ok(pcs) = std::env::var("PCS") {
        for (k, p) in pcs.split(',').enumerate() {
            ...
            assert_eq!(
                tr.stop,
                oracle::CpuTraceStop::TargetReached,
                "missed {pc:06x}"
            );
