...
(async () => {
  ...
  return {kind:'real-browser-new-game-house-exploration', initial, checkpoints:evidence, final,
    limits:'Default-name semantic start; intro/dialogue presentation omitted. Marker, static BG1, passive cardinal walking and two endpoint-timed doorways only.'};
})()
